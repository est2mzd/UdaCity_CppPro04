...
// Task L3.1 : Safeguard all accesses to the private members _vehicles and _promises with an appropriate locking mechanism, 
// that will not cause a deadlock situation where access to the resources is accidentally blocked.

int WaitingVehicles::getSize()
{
    std::lock_guard<std::mutex> lock_g(_mutex); // Task L3.1
...
{
    // Task L3.3 : Ensure that the text output locks the console as a shared resource. 

...
void WaitingVehicles::permitEntryToFirstInQueue()
{
    ...
    _promises.front().set_value(); // promise is created in "Intersection::addVehicleToQueue"
...
void Intersection::addVehicleToQueue(std::shared_ptr<Vehicle> vehicle)
{
    ...
    // Task L2.2 : First, add the new vehicle to the waiting line by creating a promise, 
    ...
    ftr.wait(); // wait until prms will do "set_value()" int "WaitingVehicles::permitEntryToFirstQueue()"
